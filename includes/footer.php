        ...
        <div class="one notopmargin tweet">
			<div class="one-fourth notopmargin">
                ...
                <h4 class="left">
                	<a href="mtasa://mta.unitedgaming.org:22003">Server IP: <span class="colored">91.121.79.80</span></a><br><br/>
                </h4>
		</div>
        </div>
        <!-- END OTHER -->
...
<?php } ?>
        ...
        <div class="one bottom-line notopmargin">
            <p class="margin15 left"><br><br/>&copy; Copyright 2012 - <?php echo $global['Footer']['Year'];?> UnitedGaming, User Control Panel</p>
